...
import (
	...
	"github.com/m3m12g/goardanfinal/app/sales-api/handlers"
...
func run(log *log.Logger) error {
	...
	var cfg struct {
		...
		Auth struct {
			...
			Algoritm       string `conf:"default:RS256"`
		}
		DB struct {
			User       string `conf:"default:postgres"`
			Password   string `conf:"default:limara2015,noprint"`
	...
	auth, err := auth.New(cfg.Auth.Algoritm, lookup, auth.Keys{cfg.Auth.KeyID: privateKey})
	if err != nil {
